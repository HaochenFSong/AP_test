...
### Calculating FPR and critical value for case where effect size is 0, to find critical values for APT_{ban UR} Setting: batch_size = 1
```{r FPR, echo=TRUE}
set.seed(0)
...
```
### Calculating FPR and critical value for case where effect size is 0, to find critical values for APT_{ban UR} Setting: batch_size = 3
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0, to find critical values for APT_{ban UR} Setting: batch_size = 5
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
p0 <- 0.5 - effect_size / 2
p1 <- 0.5 + effect_size / 2
N <- 500 # sample_size(total number of trials in one simulation)
B <- 5000 # number of simulations
c <- 0.1 # threshold
burn_in <- 4 # # of burnin trials
n <-  5 # batch_size
Ti <- N/n # num_batches
...
### Calculating FPR and critical value for case where effect size is 0, to find critical values for APT_{ban UR} Setting: batch_size = 10
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
p0 <- 0.5 - effect_size / 2
p1 <- 0.5 + effect_size / 2
N <- 1000 # sample_size(total number of trials in one simulation)
B <- 5000 # number of simulations
c <- 0.1 # threshold
burn_in <- 9 # # of burnin trials
n <-  10 # batch_size
Ti <- N/n # num_batches
...
## Setting 2 H_a armdiff = 0.05 i.e. p1 - p0 = 0.05

### Calculating FPR and critical value for case where effect size is 0.05, to find critical values for APT_{ban UR} Setting: batch_size = 1

```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
effect_size <- 0.05 # effect size is 0.05: p1 - p0 = 0.05
p0 <- 0.5 - effect_size / 2
p1 <- 0.5 + effect_size / 2
N <- 100 # sample_size(total number of trials in one simulation)
B <- 5000 # number of simulations
...
### Calculating FPR and critical value for case where effect size is 0.05, to find critical values for APT_{ban UR} Setting: batch_size = 3
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.05, to find critical values for APT_{ban UR} Setting: batch_size = 5
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.05, to find critical values for APT_{ban UR} Setting: batch_size = 10
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
## Setting 3 H_a armdiff = 0.1 i.e. p1 - p0 = 0.1

### Calculating FPR and critical value for case where effect size is 0.1, to find critical values for APT_{ban UR} Setting: batch_size = 1

```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
effect_size <- 0.1 # effect size is 0.1: p1 - p0 = 0.1
p0 <- 0.5 - effect_size / 2
p1 <- 0.5 + effect_size / 2
N <- 100 # sample_size(total number of trials in one simulation)
B <- 5000 # number of simulations
...
### Calculating FPR and critical value for case where effect size is 0.1, to find critical values for APT_{ban UR} Setting: batch_size = 3
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.1, to find critical values for APT_{ban UR} Setting: batch_size = 5
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.1, to find critical values for APT_{ban UR} Setting: batch_size = 10
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
## Setting 4 H_a armdiff = 0.2 i.e. p1 - p0 = 0.2

### Calculating FPR and critical value for case where effect size is 0.2, to find critical values for APT_{ban UR} Setting: batch_size = 1

```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
effect_size <- 0.2 # effect size is 0.2: p1 - p0 = 0.2
p0 <- 0.5 - effect_size / 2
p1 <- 0.5 + effect_size / 2
N <- 100 # sample_size(total number of trials in one simulation)
B <- 5000 # number of simulations
...
### Calculating FPR and critical value for case where effect size is 0.2, to find critical values for APT_{ban UR} Setting: batch_size = 3
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.2, to find critical values for APT_{ban UR} Setting: batch_size = 5
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.2, to find critical values for APT_{ban UR} Setting: batch_size = 10
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
## Setting 5 H_a armdiff = 0.4 i.e. p1 - p0 = 0.4

### Calculating FPR and critical value for case where effect size is 0.4, to find critical values for APT_{ban UR} Setting: batch_size = 1

```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
effect_size <- 0.4 # effect size is 0.4: p1 - p0 = 0.4
p0 <- 0.5 - effect_size / 2
p1 <- 0.5 + effect_size / 2
N <- 100 # sample_size(total number of trials in one simulation)
B <- 5000 # number of simulations
...
### Calculating FPR and critical value for case where effect size is 0.4, to find critical values for APT_{ban UR} Setting: batch_size = 3
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.4, to find critical values for APT_{ban UR} Setting: batch_size = 5
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR and critical value for case where effect size is 0.4, to find critical values for APT_{ban UR} Setting: batch_size = 10
```{r FPR, echo=TRUE}
set.seed(0)
#calculate power and reward in case p0 < p1
alpha <- 0.05
...
### Calculating FPR for case where effect size is 0, to find critical values for APT_w_UR Setting: batch_size = 1
...
### Calculating FPR for case where effect size is 0, to find critical values for APT_w_UR Setting: batch_size = 3
...
### Calculating FPR for case where effect size is 0, to find critical values for APT_w_UR Setting: batch_size = 5
...
### Calculating FPR for case where effect size is 0, to find critical values for APT_w_UR Setting: batch_size = 10
...
### Calculating FPR for case where effect size is 0.05, to find critical values for APT_w_UR Setting: batch_size = 1
...
### Calculating FPR for case where effect size is 0.05, to find critical values for APT_w_UR Setting: batch_size = 3
...
### Calculating FPR for case where effect size is 0.05, to find critical values for APT_w_UR Setting: batch_size = 5
...
### Calculating FPR for case where effect size is 0.05, to find critical values for APT_w_UR Setting: batch_size = 10
...
### Calculating FPR for case where effect size is 0.1, to find critical values for APT_w_UR Setting: batch_size = 1
...
### Calculating FPR for case where effect size is 0.1, to find critical values for APT_w_UR Setting: batch_size = 3
...
### Calculating FPR for case where effect size is 0.1, to find critical values for APT_w_UR Setting: batch_size = 5
...
### Calculating FPR for case where effect size is 0.1, to find critical values for APT_w_UR Setting: batch_size = 10
...
### Calculating FPR for case where effect size is 0.2, to find critical values for APT_w_UR Setting: batch_size = 1
...
### Calculating FPR for case where effect size is 0.2, to find critical values for APT_w_UR Setting: batch_size = 3
...
### Calculating FPR for case where effect size is 0.2, to find critical values for APT_w_UR Setting: batch_size = 5
...
### Calculating FPR for case where effect size is 0.2, to find critical values for APT_w_UR Setting: batch_size = 10
...
### Calculating FPR for case where effect size is 0.4, to find critical values for APT_w_UR Setting: batch_size = 1
...
### Calculating FPR for case where effect size is 0.4, to find critical values for APT_w_UR Setting: batch_size = 3
...
### Calculating FPR for case where effect size is 0.4, to find critical values for APT_w_UR Setting: batch_size = 5
...
### Calculating FPR for case where effect size is 0.4, to find critical values for APT_w_UR Setting: batch_size = 10
