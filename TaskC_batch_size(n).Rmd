...
#' @param burnin number of trials that runs only uniform random sampling before applying TS-Post Diff to provide more successes and failures in the beta distribution # nolint
